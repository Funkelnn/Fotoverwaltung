...
export function initializeUploadPhotoModal() {
    const modalContainer = document.getElementById('upload-photo-modal');
    const modalCloseButton = document.getElementById('modal-close-upload');
    const modalSaveButton = document.getElementById('modal-save-upload');
